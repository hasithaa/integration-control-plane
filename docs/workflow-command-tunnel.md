...
- A runtime advertises that capability exactly while a workflow integration is registered. There is no opt-in flag: hosting workflows is what makes a runtime manageable, and a runtime without a workflow integration has nothing to manage.
