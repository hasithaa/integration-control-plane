...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      ...
      // Don't refetch every time the browser tab/window regains focus. Returning to the app would otherwise re-run all active
      // queries and flash loading states (e.g. the logs view spinner).
