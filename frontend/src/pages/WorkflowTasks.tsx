      ...
      description={
        componentLevel ? (
          ...
          <>
            {dashboard ? (
              <>
                Human tasks in <strong>{project?.name ?? scope.project}</strong> waiting for you, across every integration in the environment. Only work applicable to you is shown.
              </>
            ) : (
              <>
